...
class ImageToImagePipeline(Pipeline):
    ...
    >>> assets = Image.open(requests.get("http://images.cocodataset.org/val2017/000000039769.jpg", stream=True).raw)
    >>> assets = assets.resize((64, 64))
    >>> upscaled_img = upscaler(assets)
    >>> assets.size
    (64, 64)
